...
class QRcode
{
    ...
    public function generate($short_url="xxx")
    {

    
        //set it to writable location, a place for temp generated PNG files
        $PNG_TEMP_DIR = dirname(__FILE__).'/../..'.DIRECTORY_SEPARATOR.'public./temp'.DIRECTORY_SEPARATOR; 
        ...
        if (isset($_REQUEST['size']))
            $matrixPointSize = min(max((int)$_REQUEST['size'], 1), 10); //1-10
        ...
        if (true) { 
            ...
            //var_dump($filename);exit;
            //QRcode::png($_REQUEST['data'], $filename, $errorCorrectionLevel, $matrixPointSize, 2);  2= margin  
            qrcode\QRcode::png($data, $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
